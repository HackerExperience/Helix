defmodule Helix.Hardware.Repo.Migrations.AddComponentSpecialization do
  ...
  def change do
    ...
    create table(:hdds, primary_key: false) do
      add :hdd_id, references(:components, column: :component_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create table(:cpus, primary_key: false) do
      add :cpu_id, references(:components, column: :component_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create table(:rams, primary_key: false) do
      add :ram_id, references(:components, column: :component_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create table(:nics, primary_key: false) do
      add :nic_id, references(:components, column: :component_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create unique_index(:nics, :mac_address)
    ...
    create table(:nic_ips, primary_key: false) do
      add :nic_id, references(:nics, column: :nic_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create unique_index(:nic_ips, :ip)
