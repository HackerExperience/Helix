defmodule Helix.Hardware.Controller.HardwareService do
  ...
  # alias Helix.Hardware.Controller.MotherboardSlot, as: [...]
  ...
  # @spec handle_call({:setup, HELL.PK.t, %{motherboard: String.t, components:
  # [{String.t, String.t}]}}, GenServer.from, state) ::
  ...
  # @doc false
  # def handle_call({:motherboard, :create, {:component_spec, :id, spec_id}},
  # _from, state) do
  #   with \
