defmodule Helix.Test.Entity.Factory do
  ...
  def entity_factory do
    ...
    %Entity{
      # Since entity IDs are provided by their specializations, they are not
      # autogenerated on the entity model. For this factory to work we simply
