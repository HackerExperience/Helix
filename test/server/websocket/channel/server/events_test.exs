defmodule Helix.Server.Websocket.Channel.Server.EventsTest do
  ...
  # As such, we use `ProcessCreatedEvent` here merely as an example.
  describe "notification_handler/1" do
    test "notifies gateway that a process was created (single-server)" do
      ...
      assert internal_broadcast == event
