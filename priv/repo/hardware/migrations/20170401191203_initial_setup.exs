defmodule Helix.Hardware.Repo.Migrations.InitialSetup do
  ...
  def change do
    ...
    create table(:motherboards, primary_key: false) do
      add :motherboard_id,
        references(
          :components, column: :component_id, type: :inet,
          on_delete: :delete_all, name: :motherboards_motherboard_id_fkey),
        primary_key: true
    ...
    create table(:motherboard_slots) do
      ...
      add :motherboard_id,
        references(:motherboards, column: :motherboard_id, type: :inet,
    ...
    create unique_index(:network_connections, [:network_id, :ip],
      name: :network_connections_network_id_ip_unique_index)
    create constraint(:network_connections, :non_neg_downlink,
      check: "downlink >= 0")
    create constraint(:network_connections, :non_neg_uplink,
      check: "uplink >= 0")
    ...
    create table(:hdds, primary_key: false) do
      add :hdd_id,
        references(:components, column: :component_id, type: :inet,
          on_delete: :delete_all, name: :hdds_hdd_id_fkey),
        primary_key: true
    ...
    create table(:cpus, primary_key: false) do
      add :cpu_id,
        references(:components, column: :component_id, type: :inet,
          on_delete: :delete_all, name: :cpus_cpu_id_fkey),
        primary_key: true
    ...
    create table(:rams, primary_key: false) do
      add :ram_id,
        references(:components, column: :component_id, type: :inet,
          on_delete: :delete_all, name: :rams_ram_id_fkey),
        primary_key: true
    ...
    create table(:nics, primary_key: false) do
      add :nic_id,
        references(:components, column: :component_id, type: :inet,
          on_delete: :delete_all, name: :nics_nic_id_fkey),
        primary_key: true
      add :network_connection_id,
        references(:network_connections, column: :network_connection_id,
          type: :inet, on_delete: :nilify_all,
    ...
    create unique_index(:motherboard_slots, :link_component_id,
