defmodule Helix.Network.Repo.Migrations.InitialSetup do
  ...
  def change do
    ...
    create table(:tunnels, primary_key: false) do
      ...
      add :network_id, references(:networks, column: :network_id, type: :inet, on_delete: :delete_all), null: false
      add :gateway_id, :inet, null: false
      add :destination_id, :inet, null: false
      add :hash, :string, null: false
    end

    create unique_index(:tunnels, [:network_id, :gateway_id, :destination_id, :hash])

    create table(:links, primary_key: false) do
      add :tunnel_id, references(:tunnels, column: :tunnel_id, type: :inet, on_delete: :delete_all), primary_key: true
    ...
    create table(:connections, primary_key: false) do
      ...
      add :tunnel_id, references(:tunnels, column: :tunnel_id, type: :inet, on_delete: :delete_all), null: false
